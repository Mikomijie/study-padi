      ...
      <div className="container mx-auto px-4 py-6 sm:py-8 max-w-4xl">
        ...
        <div className="grid lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              <h2 className="font-semibold text-base sm:text-lg mb-6">Profile Information</h2>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 mb-6">
                <div className="relative">
                  ...
                  <button className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-primary flex items-center justify-center text-primary-foreground hover:scale-110 transition-transform min-h-[44px] min-w-[44px] -mr-2 -mb-2">
                    <Camera className="w-4 h-4" />
                  </button>
                </div>
                <div className="text-center sm:text-left">
                  <h3 className="font-semibold text-lg sm:text-xl">{displayName}</h3>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      value={email}
                      disabled
                      className="pl-10 h-11 sm:h-12 bg-background/50 opacity-50"
                    />
                  </div>
            ...
            <motion.div
              ...
              className="glass-card p-4 sm:p-6"
            >
              <h2 className="font-semibold text-base sm:text-lg mb-6">Preferences</h2>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="font-semibold text-base sm:text-lg">Your Achievements</h2>
              </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            >
              <div className="glass-card p-4 flex items-center gap-4">
                ...
                <div>
                  <p className="text-xl sm:text-2xl font-bold gradient-text-primary">{mockStats.totalStudyTime}</p>
              ...
              <div className="glass-card p-4 flex items-center gap-4">
                ...
                <div>
                  <p className="text-xl sm:text-2xl font-bold text-success">{mockStats.coursesCompleted}</p>
              ...
              <div className="glass-card p-4 flex items-center gap-4">
                ...
                <div>
                  <p className="text-xl sm:text-2xl font-bold gradient-text-accent">{mockStats.averageScore}%</p>
                  <p className="text-xs sm:text-sm text-muted-foreground">Average Test Score</p>
                </div>
              </div>
              ...
              <div className="glass-card p-4 flex items-center gap-4">
                ...
                <div>
                  <p className="text-base sm:text-lg font-semibold">{mockStats.joinedDate}</p>
            ...
            <motion.div
              ...
              className="glass-card p-4 sm:p-6 border-destructive/30"
            >
              <h2 className="font-semibold text-base sm:text-lg mb-4 text-destructive">Danger Zone</h2>
              <Button
                variant="outline"
                onClick={handleLogout}
                className="w-full border-destructive text-destructive hover:bg-destructive/10 min-h-[44px]"
              >
